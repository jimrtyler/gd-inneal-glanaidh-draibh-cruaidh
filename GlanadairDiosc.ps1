...
#GUI Variables
$FormTitleText = "Glanadair diosc le Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "Tagh diosc:"
$FreeSpaceLabelText = "Àite an-asgaidh (gigabytes):"
$TotalSpaceLabelText = "Àm iomlan (gigabytes):"
$JunkFoundLabelText = "junk air a lorg (gigabytes):"
$CleanDiskBtnText = "Glan an diosc *Sguab às na faidhlichean*"
$SpaceCleanedLabelText = "Àm air a ghlanadh (gigabytes):"
$LogFileLabelText = "Faidhle loga air a lorg: $abcdefg"
$CreditLabelText = "Sgriobt le Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "Faidhle loga air a lorg"
$AnalyzingDriveText = "A' mion-sgrùdadh dhràibhearan..."
$BrowsersAreRunningText = "Tha na brabhsairean a' ruith... Cuir fios chun chleachdaiche..."
$PleaseCloseBrowsersText = "Dùin a h-uile brabhsair-lìn is feuch ris a-rithist."
$CleaningDriveText = "A' glanadh an draibh..."
